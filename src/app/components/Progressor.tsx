                ...
                <div className='w-full'>
                    <div className='flex items-center w-full'>
                        <div className='w-8 h-8 shrink-0 mx-{-1px} bg-amber-400 p-1.5 flex items-center justify-center rounded-full'>
                            ...
                            <span className='text-base text-black font-bold'>01</span>
                        </div>
                        ...
                        <div className="mt-2 mr-4">
                            <h6 className="text-base font-bold text-amber-500">
                                Step 1: Choose Your Favourite Cake{" "}
                            </h6>
                    ...
                    <div className='w-full'>
                        <div className='flex items-center w-full'>
                            <div className='w-8 h-8 shrink-0 mx-{-1px} bg-amber-400 p-1.5 flex items-center justify-center rounded-full'>
                                <span className='text-base text-black font-bold'>02</span>
                            </div>
                            <div className='w-full h-1 mx-4 rounded-lg bg-cyan-500'></div>
                            </div>
                        ...
                        <div className='w-full'>
                            <div className='flex items-center w-full'>
                                <div className='w-8 h-8 shrink-0 mx-{-1px} bg-amber-400 p-1.5 flex items-center justify-center rounded-full'>
                                    <span className='text-base text-black font-bold'>03</span>
                                </div>
                                <div className='w-full h-1 mx-4 rounded-lg bg-cyan-500'></div>
                                </div>
